      ...
      >
                ...
                >
                  <Link
                    ...
                    className={`block py-3 font-sans text-sm tracking-[0.12em] uppercase border-b border-[#E8DFC8] transition-colors ${
                      active ? "text-[#F3BA2F]" : "text-[#24211C] hover:text-[#F3BA2F]"
                    }`}
        ...
        <div className="px-6 pb-10">
          <Link
            ...
            className="block w-full text-center bg-[#F3BA2F] text-[#24211C] font-sans text-xs tracking-[0.15em] uppercase py-4 hover:bg-[#D9A21B] transition-colors duration-300"
          >
            Book Your Stay
          </Link>
          <a
            ...
            className="mt-3 flex items-center justify-center gap-2 w-full text-center border border-[#E8DFC8] text-[#6D665A] font-sans text-xs tracking-[0.12em] uppercase py-4 hover:border-[#F3BA2F] hover:text-[#F3BA2F] transition-colors duration-300"
          >
