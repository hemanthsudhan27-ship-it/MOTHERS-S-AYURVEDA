      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-2.5">
          <ol className="flex items-center gap-2 font-sans text-[10px] tracking-[0.1em] uppercase text-[#6D665A]">
            <li>
              <Link href="/" className="hover:text-[#F3BA2F] transition-colors">
                Home
              </Link>
            </li>
            <li aria-hidden="true" className="text-[#F3BA2F]">·</li>
            <li>
              <Link href="/rooms" className="hover:text-[#F3BA2F] transition-colors">
                Rooms
              </Link>
            </li>
            <li aria-hidden="true" className="text-[#F3BA2F]">·</li>
            ...
            <ScrollReveal direction="right" delay={0.1}>
              <div className="lg:text-right flex lg:flex-col lg:items-end gap-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 border border-[#F3BA2F] text-[#24211C] font-sans text-xs tracking-[0.15em] uppercase px-6 py-3 hover:bg-[#F3BA2F] transition-all duration-300"
                >
                  Book Your Stay
                </Link>
              </div>
          ...
          <ScrollReveal direction="up" delay={0.05}>
            <div className="relative aspect-[16/9] lg:aspect-[21/9] overflow-hidden bg-[#E8DFC8]">
              <Image
                ...
                alt={`${room.name} at Mother's Inn Homestay — main view`}
                fill
                ...
                <dl className="space-y-4 mb-8">
                  ...
                  {room.price && (
                    <div className="flex justify-between border-b border-[#E8DFC8] pb-3">
                      ...
                      <dd className="font-sans text-xs text-[#F3BA2F] font-medium">{room.price}</dd>
                    </div>
                  )}
                </dl>
                <WhatsAppButton
            ...
            {room.amenities.map((amenity, i) => (
              <ScrollReveal key={i} direction="up" delay={i * 0.04}>
                <li className="flex items-center gap-3 bg-white p-4">
                  <span
                    className="w-1.5 h-1.5 rounded-full bg-[#F3BA2F] shrink-0"
                    aria-hidden="true"
                  />
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
              ...
              <div className="flex flex-wrap gap-4 shrink-0">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 border border-white/30 text-white font-sans text-xs tracking-[0.15em] uppercase px-6 py-3 hover:border-[#F3BA2F] hover:text-[#F3BA2F] transition-all duration-300"
                >
              ...
              {otherRooms.map((r, i) => (
                <ScrollReveal key={r.id} direction="up" delay={i * 0.08}>
                  ...
                  >
                    ...
                    <p className="font-sans text-[10px] text-[#F3BA2F] tracking-widest uppercase mb-1">
                      {r.id}
                    </p>
                    <h3 className="font-serif text-xl text-[#24211C] group-hover:text-[#D9A21B] transition-colors duration-300">
                      {r.name}
                    </h3>
                  </Link>
                </ScrollReveal>
