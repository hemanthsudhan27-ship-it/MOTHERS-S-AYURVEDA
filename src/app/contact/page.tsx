...
export const metadata: Metadata = {
  title: "Contact | Mother's Inn Homestay Kerala",
  description:
    "Get in touch with Mother's Inn Homestay. Call, WhatsApp or email us — we'd love to hear from you.",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0 border-t border-[#E8DFC8]">
            ...
            <ScrollReveal direction="up">
              <div className="pt-10 pb-10 pr-0 sm:pr-10">
                <div className="w-10 h-10 border border-[#F3BA2F] flex items-center justify-center mb-6">
                  <svg
                    className="w-4 h-4 text-[#F3BA2F]"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.5"
                ...
                <p className="font-sans text-[10px] tracking-[0.2em] uppercase text-[#F3BA2F] mb-3">
                  Call Us
                </p>
                <a
                  href={`tel:${siteConfig.phone}`}
                  className="font-serif text-2xl text-[#24211C] hover:text-[#F3BA2F] transition-colors duration-300"
                >
                  {siteConfig.phone}
                </a>
              </div>
              ...
              <div className="pt-10 pb-10 pr-0 sm:pr-10 border-t lg:border-t-0 lg:border-l border-[#E8DFC8]">
                <div className="lg:pl-10">
                  ...
                  <a
                    ...
                    className="font-serif text-xl text-[#24211C] hover:text-[#F3BA2F] transition-colors duration-300 break-all"
                  >
                    {siteConfig.email}
                  </a>
                </div>
